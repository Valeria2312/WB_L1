...
//Показываем сложность пароля и подсказки, если они необходимы
    if (strength === 0) {
        check.textContent =  "Очень слабый пароль. Пароль должен содержать хотя бы одну заглавную букву, цифру или символ";
        check.style.color = '#e7140d';
    }
    else if (strength === 1) {
        check.textContent =  "Слабый пароль. Добавьте заглавную букву, цифры или символы";
        check.style.color = '#e7140d';
    }
    else if (strength === 2) {
