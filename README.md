...
10. Реализовать функцию конвертации строки в JSON со всеми необходимыми проверками и валидациями.
    ~прикол в том что что у json не может быть методов, и например если вы конвертируете объект в json он должен еще эти методы удалять~
